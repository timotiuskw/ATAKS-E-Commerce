...
<div class="card">
	<div class="card-body">
        ...
        <a href="list-product.php?page=editProfile">Edit Profile</a><br><br>
		...
		<form class="row g-3" action="updProfile.php" method="post" enctype="multipart/form-data">
			...
			<div class="col-12">
				...
				<input type="text" class="form-control" id="thrg" name="talamat" value="<?= $alamat;?>" readonly>
			</div>
			<div class="col-12">
				<label for="ttgllahir" class="form-label">Tanggal Lahir</label>
				<input type="text" class="form-control" id="tjml" name="ttgllahir" value="<?= $tgllahir;?>" readonly>
			</div>
			<div class="col-12">
				<label for="tnotelp" class="form-label">No. Telepon</label>
				<input type="text" class="form-control" id="tket" name="tnotelp" value="<?= $notelp;?>" readonly>
			</div>
            <div class="col-12">
				<label for="temail" class="form-label">Email</label>
				<input type="text" class="form-control" id="tket" name="temail" value="<?= $email;?>" readonly>
			</div>
            <div class="col-12">
